          ...
          gpointer        user_data)
{
  ...
  const char *distros[] = {"README.md", "add.c", "closeWindow.c", "copyFile.c", "delete.c", "history.c", "init.c", "library.c", "main.c", "message.c", "myCSS.c", "mystyle.css", "restore.c", "search.c", "setTextView.c", "setting.c", "sourceCode.c", "team.c", "toturial.c"};
